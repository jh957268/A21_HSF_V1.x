...
#define CFG_USER_STR_ENTRY_( c)     { CFG_##c, #c }
	...
	CFG_USER_STR_ENTRY_(GAFFER_ENABLE),
	CFG_USER_STR_ENTRY_(GAFFER_SUBNET),
	CFG_USER_STR_ENTRY_(GAFFER_UNIVERSE),
    CFG_USER_STR_ENTRY_(GAFFER_LOWER),
    CFG_USER_STR_ENTRY_(GAFFER_UPPER),	
    { 0, 0 }
};
