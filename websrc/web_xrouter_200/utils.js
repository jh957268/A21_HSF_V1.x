...
function index_page()
{
	...
	if (lang== "CN")
	{
		page_opmode= "CN/opmode.html";
		page_tree= "CN/treeappCN.html";
	}
	else
	{
		page_opmode= "EN/opmode.html";
		page_tree= "EN/treeappEN.html";
	}
	m= '<frame SRC='+page_tree+' name="menu" MARGINWIDTH="10" MARGINHEIGHT="10" scrolling="AUTO" FRAMEBORDER="NO">';
	m+= '<frame SRC='+page_opmode+' name="view" SCROLLING="AUTO" MARGINWIDTH="0" TOPMARGIN="0" MARGINHEIGHT="0" FRAMEBORDER="NO">';
	document.write(m);
}

function src_change()
{	
	var lang_iframe = document.getElementById("lang_iframe_id");
	lang_iframe.src="";
}
...
{	
	var lang_iframe = document.getElementById("lang_iframe_id");
		lang_iframe.src="CN/set_lang_zhcn.html";
		setTimeout("src_change()",50);
		setTimeout("Xreload()",60);
}

function setLanguageEN()
{	
	var lang_iframe = document.getElementById("lang_iframe_id");
		lang_iframe.src="EN/set_lang_en.html";
		setTimeout("src_change()",50);
		setTimeout("Xreload()",60);
}
