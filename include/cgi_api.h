...
//menghui add 
//menghui
extern  void m2m_debug_web_show(http_req *req);
extern  void CGI_m2m_get_cur_profile(http_req *req);

#define CGI_SHOW_LOG()		m2m_debug_web_show(req)
#define CGI_GET_CUR_PROFILE()	CGI_m2m_get_cur_profile(req)

#define CGI_MAP_ASP(name,id)	CGI_var_map(req,name,id)
#define CGI_MAP_ARRAY_ASP(name,id,num)	CGI_var_map_array(req,name,id,num)
#define NTP_GETLOCALTIME(_flags)	ntp_getlocaltime(_flags)
#ifdef	CONFIG_DDNS
#define ORAY_PASSPORT_TYPE()		oray_passport_type()
#define ORAY_ONLINE_STATUS()		oray_online_status()
#endif
extern int m2m_nlink_state;
#define M2M_NLINK_STATE()			WEB_printf(req, "%d",m2m_nlink_state)
#define CGI_SET_RESTART() 									CGI_set_restart(req)
//#define	CGI_GET_VERSION_HF()	CGI_GET_FVERSION()
#define	CGI_GET_WAN_IP()		CGI_WAN_IP()
extern void CGI_flash_read(http_req *req);
#define CGI_FLASH_READ()			CGI_flash_read(req)

#define CGI_SET_ETH() 									CGI_set_eth(req)
#define CGI_SET_NETH() 									CGI_set_neth(req)
#define	CGI_GET_WAN_MAC_ADDRESS()	CGI_WAN_MAC()
...
#define CGI_GET_FVERSION()										CGI_get_fversion(req)		//an
#define CGI_GET_FLOGO() 									CGI_get_flogo(req)		//an
#define CGI_SET_FLANGZHCN() 								CGI_set_flangzhcn(req)		//an
#define CGI_SET_FLANGEN() 									CGI_set_flangen(req)		//an
#define CGI_GET_FLANG() 									CGI_get_flang(req)			// gohuy
#define CGI_GET_VERSION() 							CGI_get_version(req)			// gohuy
#define CGI_GET_SURVEYLIST() 							getsurveylist(req)			// gohuy
#define CGI_IS_ADMIN()							{ WEB_printf(req, "%d", CGI_check_is_admin(req)); }	//menghui
...
extern void getsurveylist(http_req *req);
extern void	CGI_get_fversion(http_req *req);	
extern void CGI_get_flogo(http_req *req);
extern void CGI_set_flangzhcn(http_req *req);
extern void CGI_set_flangen(http_req *req);
extern void CGI_get_flang(http_req *req);
extern void CGI_set_flangcn(http_req *req);
extern void CGI_get_version(http_req *req);
...
extern int CGI_check_is_admin(http_req *req);//menghui

#include <usercgi.h> //menghui
