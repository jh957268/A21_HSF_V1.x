...
#endif
#define CFG_ID_M2M	17
#define CFG_ID_USER	18
...
//User
#define CFG_USER_(idx,type) 			CFG_ID_(CFG_ID_USER,idx,type,0)
#define CFG_AKS_NAME			        CFG_USER_(1,CFG_TYPE_STR)
#define CFG_AKS_UNIVERSE			        CFG_USER_(2,CFG_TYPE_INT)
#define CFG_AKS_SUBNET			        CFG_USER_(3,CFG_TYPE_INT)
#define CFG_TIMO_POWER			        CFG_USER_(4,CFG_TYPE_INT)
#define CFG_AKS_SETTINGS			        CFG_USER_(5,CFG_TYPE_STR)
#define CFG_AKS_CHANNEL_WIDTH		        CFG_USER_(6,CFG_TYPE_INT)
#define CFG_AKS_SECOND_CHANNEL		        CFG_USER_(7,CFG_TYPE_INT)

#define CFG_AKS_CONS1			        CFG_USER_(8,CFG_TYPE_STR)
#define CFG_AKS_CONS2			        CFG_USER_(9,CFG_TYPE_STR)
#define CFG_AKS_CONS3			        CFG_USER_(10,CFG_TYPE_STR)
#define CFG_AKS_CONS4			        CFG_USER_(11,CFG_TYPE_STR)
#define CFG_AKS_CONS5			        CFG_USER_(12,CFG_TYPE_STR)
#define CFG_AKS_CONS6			        CFG_USER_(13,CFG_TYPE_STR)
#define CFG_AKS_CONS7			        CFG_USER_(14,CFG_TYPE_STR)
#define CFG_AKS_CONS8			        CFG_USER_(15,CFG_TYPE_STR)
#define CFG_AKS_CONS9			        CFG_USER_(16,CFG_TYPE_STR)
#define CFG_AKS_CONS10			        CFG_USER_(17,CFG_TYPE_STR)
#define CFG_AKS_CONS11			        CFG_USER_(18,CFG_TYPE_STR)
#define CFG_AKS_CONS12			        CFG_USER_(19,CFG_TYPE_STR)
#define CFG_AKS_CONS13			        CFG_USER_(20,CFG_TYPE_STR)
#define CFG_AKS_CONS14			        CFG_USER_(21,CFG_TYPE_STR)
#define CFG_AKS_CONS15			        CFG_USER_(22,CFG_TYPE_STR)
#define CFG_AKS_CONS16			        CFG_USER_(23,CFG_TYPE_STR)
#define CFG_SET_ID						CFG_USER_(24,CFG_TYPE_STR)
#define CFG_SET_LINK					CFG_USER_(25,CFG_TYPE_STR)
#define CFG_SET_UNLINK					CFG_USER_(26,CFG_TYPE_STR)

#define CFG_SET_UNIV0					CFG_USER_(27,CFG_TYPE_STR)
#define CFG_SET_UNIV1					CFG_USER_(28,CFG_TYPE_STR)
#define CFG_SET_UNIV2					CFG_USER_(29,CFG_TYPE_STR)
#define CFG_SET_UNIV3					CFG_USER_(30,CFG_TYPE_STR)
#define CFG_SET_UNIV4					CFG_USER_(31,CFG_TYPE_STR)
#define CFG_SET_UNIV5					CFG_USER_(32,CFG_TYPE_STR)
#define CFG_SET_UNIV6					CFG_USER_(33,CFG_TYPE_STR)
#define CFG_SET_UNIV7					CFG_USER_(34,CFG_TYPE_STR)
#define CFG_SET_UNIV8					CFG_USER_(35,CFG_TYPE_STR)
#define CFG_SET_UNIV9					CFG_USER_(36,CFG_TYPE_STR)
#define CFG_SET_UNIV10					CFG_USER_(37,CFG_TYPE_STR)
#define CFG_SET_UNIV11					CFG_USER_(38,CFG_TYPE_STR)
#define CFG_SET_UNIV12					CFG_USER_(39,CFG_TYPE_STR)
#define CFG_SET_UNIV13					CFG_USER_(40,CFG_TYPE_STR)
#define CFG_SET_UNIV14					CFG_USER_(41,CFG_TYPE_STR)
#define CFG_SET_UNIV15					CFG_USER_(42,CFG_TYPE_STR)

#define CFG_GAFFER_UNIVERSE			    CFG_USER_(43,CFG_TYPE_INT)
#define CFG_GAFFER_SUBNET			    CFG_USER_(44,CFG_TYPE_INT)
#define CFG_GAFFER_ENABLE				CFG_USER_(45,CFG_TYPE_INT)
...
#define CFG_AKS_CONS17			        CFG_USER_(75,CFG_TYPE_STR)
#define CFG_AKS_CONS18			        CFG_USER_(76,CFG_TYPE_STR)
#define CFG_AKS_CONS19			        CFG_USER_(77,CFG_TYPE_STR)
#define CFG_AKS_CONS20			        CFG_USER_(78,CFG_TYPE_STR)
#define CFG_AKS_CONS21			        CFG_USER_(79,CFG_TYPE_STR)
#define CFG_AKS_CONS22			        CFG_USER_(80,CFG_TYPE_STR)
#define CFG_AKS_CONS23			        CFG_USER_(81,CFG_TYPE_STR)
#define CFG_AKS_CONS24			        CFG_USER_(82,CFG_TYPE_STR)
#define CFG_AKS_CONS25			        CFG_USER_(83,CFG_TYPE_STR)
#define CFG_AKS_CONS26			        CFG_USER_(84,CFG_TYPE_STR)
#define CFG_AKS_CONS27			        CFG_USER_(85,CFG_TYPE_STR)
#define CFG_AKS_CONS28			        CFG_USER_(86,CFG_TYPE_STR)
#define CFG_AKS_CONS29			        CFG_USER_(87,CFG_TYPE_STR)
#define CFG_AKS_CONS30			        CFG_USER_(88,CFG_TYPE_STR)
#define CFG_AKS_CONS31			        CFG_USER_(89,CFG_TYPE_STR)
#define CFG_AKS_CONS32			        CFG_USER_(90,CFG_TYPE_STR)

#define CFG_AKS_ADVA17			        CFG_USER_(91,CFG_TYPE_STR)
#define CFG_AKS_ADVA18			        CFG_USER_(92,CFG_TYPE_STR)
#define CFG_AKS_ADVA19			        CFG_USER_(93,CFG_TYPE_STR)
#define CFG_AKS_ADVA20			        CFG_USER_(94,CFG_TYPE_STR)
#define CFG_AKS_ADVA21			        CFG_USER_(95,CFG_TYPE_STR)
#define CFG_AKS_ADVA22			        CFG_USER_(96,CFG_TYPE_STR)
#define CFG_AKS_ADVA23			        CFG_USER_(97,CFG_TYPE_STR)
#define CFG_AKS_ADVA24			        CFG_USER_(98,CFG_TYPE_STR)
#define CFG_AKS_ADVA25			        CFG_USER_(99,CFG_TYPE_STR)
#define CFG_AKS_ADVA26			        CFG_USER_(100,CFG_TYPE_STR)
#define CFG_AKS_ADVA27			        CFG_USER_(101,CFG_TYPE_STR)
#define CFG_AKS_ADVA28			        CFG_USER_(102,CFG_TYPE_STR)
#define CFG_AKS_ADVA29			        CFG_USER_(103,CFG_TYPE_STR)
...
#define CFG_M2M_UART_BAUD	            	CFG_M2M_(2,CFG_TYPE_INT)
#define CFG_M2M_UART_STOP			CFG_M2M_(3,CFG_TYPE_INT)
#define CFG_M2M_UART_PARITY		CFG_M2M_(4,CFG_TYPE_INT)
#define CFG_M2M_UART_BITS			CFG_M2M_(5,CFG_TYPE_INT)
#define CFG_M2M_UART_FC			CFG_M2M_(6,CFG_TYPE_INT)
#define CFG_M2M_UART_AF			CFG_M2M_(7,CFG_TYPE_STR)
#define CFG_M2M_UART_AFT			CFG_M2M_(8,CFG_TYPE_INT)
#define CFG_M2M_UART_AFL			CFG_M2M_(9,CFG_TYPE_INT)
#define CFG_M2M_NET_PROC			CFG_M2M_(11,CFG_TYPE_STR)
#define CFG_M2M_NET_MODE			CFG_M2M_(12,CFG_TYPE_STR)
#define CFG_M2M_NET_PORT			CFG_M2M_(13,CFG_TYPE_INT)
#define CFG_M2M_NET_SERADD		CFG_M2M_(14,CFG_TYPE_STR)
#define CFG_M2M_NET_TCPTO			CFG_M2M_(15,CFG_TYPE_INT)
#define CFG_M2M_NET_MAXSK			CFG_M2M_(16,CFG_TYPE_INT)
#define CFG_M2M_NET2_ENABLE		CFG_M2M_(17,CFG_TYPE_INT)
#define CFG_M2M_NET2_PORT			CFG_M2M_(18,CFG_TYPE_INT)
#define CFG_M2M_NET2_SERADD		CFG_M2M_(19,CFG_TYPE_STR)
#define CFG_M2M_NET2_TCPTO		CFG_M2M_(20,CFG_TYPE_INT)
#define CFG_M2M_MODULE_ID			CFG_M2M_(30,CFG_TYPE_STR)
#define CFG_M2M_MLANGW			CFG_M2M_(31,CFG_TYPE_STR)
#define CFG_M2M_FVEW			CFG_M2M_(32,CFG_TYPE_STR)
#define CFG_M2M_EPHY			CFG_M2M_(33,CFG_TYPE_STR)
#define CFG_M2M_ENABLE_RELDBTN	CFG_M2M_(34,CFG_TYPE_STR)
#define CFG_M2M_ECHO_CLOSE		CFG_M2M_(35,CFG_TYPE_STR)
#define CFG_M2M_NRDY			CFG_M2M_(36,CFG_TYPE_STR)
#define CFG_M2M_IOCONTROL		CFG_M2M_(37,CFG_TYPE_STR)
#define CFG_M2M_IODEFAULT		CFG_M2M_(38,CFG_TYPE_STR)
#define CFG_M2M_NET2_TLSEN		CFG_M2M_(39,CFG_TYPE_STR)

#define CFG_M2M_WIFI_MODE		CFG_M2M_(45,CFG_TYPE_STR)
...
#define CFG_SYS_ADMPASS1    (CFG_SYS_ADMPASS+1) //menghui
...
#define CFG_SYS_USERS1		(CFG_SYS_USERS+1)	//menghui
...
unsigned int get_cfg_id_by_name(const char *name);
