...
#define HFTHREAD_PRIORITIES_LOW		(14)

#define HFTHREAD_PRIORITIES_MID		(6)

#define HFTHREAD_PRIORITIES_NORMAL	(4)

#define HFTHREAD_PRIORITIES_HIGH		(3)

#define HFTHREAD_MAX_PRIORITIES		(1)

#define HFTHREAD_STACK_SIZE		(0x1000)
...
extern void u_delay(uint32_t n);
...
#ifndef sleep
#define sleep(_s)	(cyg_thread_delay((_s)*100))
#endif
