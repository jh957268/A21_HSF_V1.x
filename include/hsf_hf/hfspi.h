...
int HSF_API hfspi_master_init(unsigned char mode, unsigned char clk_div);

int HSF_API hfspi_master_send_data(char* send_buf, unsigned int length);

int HSF_API hfspi_master_recv_data(char* buf,unsigned int length);
