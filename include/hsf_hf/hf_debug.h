...
#define DEBUG_HTTPD			DEBUG_LEVEL_MID
...
extern int hf_debug_level;


#define __HF_DEBUG

#ifdef __HF_DEBUG
#define HF_Debug( debug_level , ... )	do{if(debug_level < hf_debug_level||hf_debug_level<=DEBUG_LEVEL_CLOSE){break;}M2M_PRINTF(__VA_ARGS__);}while(0) 
