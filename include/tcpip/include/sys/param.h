...
#define __hostname__	"ecos.host" //Eddy debug
...
#define mclfree_4k cyg_mclfree_4k
#define mbstat_4k cyg_mbstat_4k
#endif
...
#define time_usec  ktime.tv_usec
...
extern cyg_uint32 cyg_splinternal_debug(const char *file, const int line);
...
#define cyg_splinternal() cyg_splinternal_debug( __FUNCTION__, __LINE__)
...
#define MCLSHIFT        11 //Eddy       /* convert bytes to m_buf clusters */
#define MCLBYTES        (1 << MCLSHIFT) /* size of a m_buf cluster */
#define MCLOFSET        (MCLBYTES - 1)  /* offset within a m_buf cluster */
#define CLBYTES         2048            /* size of actual cluster */
#define PAGE_SIZE       CLBYTES
#else
#define MSIZE           128             /* size of an mbuf */
#define MCLSHIFT        12 //Eddy       /* convert bytes to m_buf clusters */
#define MCLBYTES        (1 << MCLSHIFT) /* size of a m_buf cluster */
#define MCLOFSET        (MCLBYTES - 1)  /* offset within a m_buf cluster */
...
#define BSD 199506 //Added by Eddy
