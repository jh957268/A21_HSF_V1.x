...
int flsh_erase_cmm(unsigned int addr, unsigned int len);
int flsh_write_cmm(unsigned int addr, unsigned int from, unsigned int len);


int flsh_hfcfg_read(unsigned int addr, unsigned int to, unsigned int len);
int flsh_hfcfg_write(unsigned int addr, unsigned int from, unsigned int len);
int flsh_hfcfg_erase(unsigned int addr, unsigned int len);
